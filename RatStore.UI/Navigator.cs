...
{
    /// <summary>
    /// Contains a reference for the current store and customer for the console app, as well as the cart.
    /// Only for console functionality. Replaced by the Cart class and better design.
    /// </summary>
